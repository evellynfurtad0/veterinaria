...
( 
 Telefone VARCHAR(20),  
 Nome VARCHAR(80),  
 ID_Dono_animal INT PRIMARY KEY,  
 Email VARCHAR(100),  
 CPF VARCHAR(14),  
...
INSERT INTO Dono_animal (ID_Dono_animal, Nome, Telefone, Email, CPF, Endereco) VALUES 
(1, 'João', '(11) 9999-8888', 'joao@email.com', '123.456.789-00', 'Rua das Flores, 100'),
(2, 'Maria', '(11) 7777-6666', 'maria@email.com', '987.654.321-00', 'Av. Central, 200');

INSERT INTO Animal (ID_Animal, Nome, Especie, Raca, Idade, Sexo, Peso, Observacao, idDono_animal) VALUES 
(1, 'Rex', 'Cachorro', 'Labrador', 5, 'Macho', 25.5, 'Saudável', 1),
(2, 'Mimi', 'Gato', 'Siamês', 3, 'Fêmea', 4.2, 'Alergia leve', 2);
...
(1, '2024-01-15', 'Vacinação', '10:00', 'Aplicação da antirrábica', 1, 1),
